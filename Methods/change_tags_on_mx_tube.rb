def change_tags_on_batch(tags,tag_group,mx_tube,mode,rt_ticket,login)
  ...
  def change_tags(lib_aliquots, sample_tag_hash, tag_group, rt_ticket, user, version)
    c = lib_aliquots.size
  ...
  change_tags(lib_aliquots,sample_tag_hash,tag_group,rt_ticket,user,version)
